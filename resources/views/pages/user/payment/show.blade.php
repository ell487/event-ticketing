...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="bg-slate-800 rounded-2xl border border-slate-700 shadow-lg p-8">
        <h2 class="text-2xl font-black text-white mb-6 text-center border-b border-slate-700 pb-4">💳 Simulasi Pembayaran</h2>
        ...
        <form action="{{ route('payment.process', $transaction->invoice_code) }}" method="POST">
            @csrf
            <div class="mb-6">
